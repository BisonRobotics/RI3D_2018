...
public class OI {
    ...
    public OI() {
        ...
        elevatorDownButton = new JoystickButton(driver, 4);
        elevatorDownButton.whileHeld(new ElevatorDown());
        elevatorUpButton = new JoystickButton(driver, 6);
        elevatorUpButton.whileHeld(new ElevatorUp());
        climberDownButton = new JoystickButton(driver, 3);
        climberDownButton.whileHeld(new ClimberDown());
        cLimberUpButton = new JoystickButton(driver, 5);
        cLimberUpButton.whileHeld(new ClimberUp());
